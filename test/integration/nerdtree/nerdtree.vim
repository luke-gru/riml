...
function! nerdtree#createDefaultBindings()
  let s = '<SNR>' . s:SID() . '_'
  call s:NERDTreeAddKeyMap({'key': '<MiddleRelease>', 'scope': "all", 'callback': s:s . "handleMiddleMouse"})
  call s:NERDTreeAddKeyMap({'key': '<LeftRelease>', 'scope': "all", 'callback': s:s . "handleLeftClick"})
  call s:NERDTreeAddKeyMap({'key': '<2-LeftMouse>', 'scope': "DirNode", 'callback': s:s . "activateDirNode"})
  call s:NERDTreeAddKeyMap({'key': '<2-LeftMouse>', 'scope': "FileNode", 'callback': s:s . "activateFileNode"})
  call s:NERDTreeAddKeyMap({'key': '<2-LeftMouse>', 'scope': "Bookmark", 'callback': s:s . "activateBookmark"})
  call s:NERDTreeAddKeyMap({'key': '<2-LeftMouse>', 'scope': "all", 'callback': s:s . "activateAll"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapActivateNode, 'scope': "DirNode", 'callback': s:s . "activateDirNode"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapActivateNode, 'scope': "FileNode", 'callback': s:s . "activateFileNode"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapActivateNode, 'scope': "Bookmark", 'callback': s:s . "activateBookmark"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapActivateNode, 'scope': "all", 'callback': s:s . "activateAll"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapOpenSplit, 'scope': "Node", 'callback': s:s . "openHSplit"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapOpenVSplit, 'scope': "Node", 'callback': s:s . "openVSplit"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapOpenSplit, 'scope': "Bookmark", 'callback': s:s . "openHSplit"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapOpenVSplit, 'scope': "Bookmark", 'callback': s:s . "openVSplit"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapPreview, 'scope': "Node", 'callback': s:s . "previewNodeCurrent"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapPreviewVSplit, 'scope': "Node", 'callback': s:s . "previewNodeVSplit"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapPreviewSplit, 'scope': "Node", 'callback': s:s . "previewNodeHSplit"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapPreview, 'scope': "Bookmark", 'callback': s:s . "previewNodeCurrent"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapPreviewVSplit, 'scope': "Bookmark", 'callback': s:s . "previewNodeVSplit"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapPreviewSplit, 'scope': "Bookmark", 'callback': s:s . "previewNodeHSplit"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapOpenRecursively, 'scope': "DirNode", 'callback': s:s . "openNodeRecursively"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapUpdir, 'scope': "all", 'callback': s:s . "upDirCurrentRootClosed"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapUpdirKeepOpen, 'scope': "all", 'callback': s:s . "upDirCurrentRootOpen"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapChangeRoot, 'scope': "Node", 'callback': s:s . "chRoot"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapChdir, 'scope': "Node", 'callback': s:s . "chCwd"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapQuit, 'scope': "all", 'callback': s:s . "closeTreeWindow"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapCWD, 'scope': "all", 'callback': "nerdtree#chRootCwd"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapRefreshRoot, 'scope': "all", 'callback': s:s . "refreshRoot"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapRefresh, 'scope': "Node", 'callback': s:s . "refreshCurrent"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapHelp, 'scope': "all", 'callback': s:s . "displayHelp"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapToggleZoom, 'scope': "all", 'callback': s:s . "toggleZoom"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapToggleHidden, 'scope': "all", 'callback': s:s . "toggleShowHidden"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapToggleFilters, 'scope': "all", 'callback': s:s . "toggleIgnoreFilter"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapToggleFiles, 'scope': "all", 'callback': s:s . "toggleShowFiles"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapToggleBookmarks, 'scope': "all", 'callback': s:s . "toggleShowBookmarks"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapCloseDir, 'scope': "Node", 'callback': s:s . "closeCurrentDir"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapCloseChildren, 'scope': "DirNode", 'callback': s:s . "closeChildren"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapMenu, 'scope': "Node", 'callback': s:s . "showMenu"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapJumpParent, 'scope': "Node", 'callback': s:s . "jumpToParent"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapJumpFirstChild, 'scope': "Node", 'callback': s:s . "jumpToFirstChild"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapJumpLastChild, 'scope': "Node", 'callback': s:s . "jumpToLastChild"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapJumpRoot, 'scope': "all", 'callback': s:s . "jumpToRoot"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapJumpNextSibling, 'scope': "Node", 'callback': s:s . "jumpToNextSibling"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapJumpPrevSibling, 'scope': "Node", 'callback': s:s . "jumpToPrevSibling"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapOpenInTab, 'scope': "Node", 'callback': s:s . "openInNewTab"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapOpenInTabSilent, 'scope': "Node", 'callback': s:s . "openInNewTabSilent"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapOpenInTab, 'scope': "Bookmark", 'callback': s:s . "openInNewTab"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapOpenInTabSilent, 'scope': "Bookmark", 'callback': s:s . "openInNewTabSilent"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapOpenExpl, 'scope': "DirNode", 'callback': s:s . "openExplorer"})
  call s:NERDTreeAddKeyMap({'key': g:NERDTreeMapDeleteBookmark, 'scope': "Bookmark", 'callback': s:s . "deleteBookmark"})
endfunction
