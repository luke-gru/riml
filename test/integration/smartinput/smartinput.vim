...
function! smartinput#define_default_rules()
  ...
  let ft_urule_sets_table = {'*': [urules.table['()'], urules.table['[]'], urules.table['{}'], urules.table[''''''], urules.table[''''''''], urules.table['""'], urules.table['"""'], urules.table['``'], urules.table['```'], urules.table['English']], 'clojure': [urules.table['Lisp quote']], 'csh': [urules.table[''''' as strong quote']], 'lisp': [urules.table['Lisp quote']], 'perl': [urules.table[''''' as strong quote']], 'python': [urules.table['Python string']], 'ruby': [urules.table[''''' as strong quote']], 'scheme': [urules.table['Lisp quote']], 'sh': [urules.table[''''' as strong quote']], 'tcsh': [urules.table[''''' as strong quote']], 'vim': [urules.table[''''' as strong quote'], urules.table['Vim script comment']], 'zsh': [urules.table[''''' as strong quote']]}
